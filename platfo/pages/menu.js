    ...
    return (
      <div style={{ background: "#161616", borderRadius: "14px", padding: "16px", display: "flex", justifyContent: "space-between", alignItems: "center", border: qty > 0 ? "1px solid rgba(255,48,8,0.4)" : "1px solid rgba(255,255,255,0.06)", transition: "all 0.2s", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px", flexShrink: 0, marginLeft: "14px" }}>
          {qty === 0 ? (
            <button onClick={() => addToCart(item)} style={{ background: "#FF3008", color: "#fff", border: "none", padding: "9px 20px", borderRadius: "10px", fontWeight: 700, cursor: "pointer", fontSize: "0.88rem", fontFamily: "sans-serif", boxShadow: "0 4px 14px rgba(255,48,8,0.3)", transition: "all 0.2s" }}>{"Add"}</button>
          ) : (
                ...
                {!showCustomerForm ? (
                  ...
                  <div>
                    ...
                    <div style={{ display: "flex", gap: "10px" }}>
                      <button onClick={() => setShowCustomerForm(false)} style={{ flex: 1, background: "rgba(255,255,255,0.06)", color: "#888", border: "none", padding: "14px", borderRadius: "12px", fontWeight: 700, cursor: "pointer", fontFamily: "sans-serif" }}>{"Back"}</button>
                      <button onClick={handleOrder} disabled={ordering} style={{ flex: 2, background: ordering ? "#333" : "#FF3008", color: ordering ? "#666" : "#fff", border: "none", padding: "14px", borderRadius: "12px", fontWeight: 700, cursor: ordering ? "not-allowed" : "pointer", fontFamily: "sans-serif", boxShadow: ordering ? "none" : "0 4px 20px rgba(255,48,8,0.3)" }}>
